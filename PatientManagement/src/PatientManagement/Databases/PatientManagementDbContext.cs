namespace PatientManagement.Databases;

using PatientManagement.Domain;
using PatientManagement.Databases.EntityConfigurations;
...
public sealed class PatientManagementDbContext : DbContext
{
    private readonly ICurrentUserService _currentUserService;
    private readonly IMediator _mediator;

    public PatientManagementDbContext(
        DbContextOptions<PatientManagementDbContext> options, ICurrentUserService currentUserService, IMediator mediator) : base(options)
    {
